                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginTop: 20 }}>
                  {sec.personas.map((p) => (
                    <div
                      key={p.name}
                      style={{
                      background: sec.personaColor || 'linear-gradient(135deg, #feba001a 0%, #FEB900 100%)',                        
                      padding: 16,
                        display: 'flex',
                        flexDirection: 'column',
                        minHeight: 340,
                    ...
                    >
                      ...
                      <h4 style={{ margin: '0 0 4px', fontSize: 15, fontWeight: 700, color: '#ffffff' }}>
                        {p.name}
                      </h4>
                      <p
                        style={{
                      ...
                      <p style={{ margin: 0, fontSize: 12, lineHeight: 1.5, color: '#f1fbec' }}>
                        {p.description}
                      </p>
                    </div>
                  ))}
        ...
        <div key={i}>
          ...
          <div style={{ marginTop: 32, display: 'flex', flexDirection: 'column', gap: 20 }}>
            {sec.findings.map((f, i) => (
              <div key={i} style={{ display: 'grid', gridTemplateColumns: '30px 1fr', gap: 1 }}>
                <span style={{ fontSize: 12, color: '#8f8f8f', letterSpacing: '0.04em', paddingTop: '3px' }}>
                  {f.number}
                </span>
                <div>
                  <h4 style={{ margin: '0 0 10px', fontSize: 26, fontWeight: 500, color: sec.FindingColor ||'#c16a00', lineHeight: 1.3 }}>
                    {f.title}
                  </h4>
                  <p style={{ margin: 0, fontSize: 15, lineHeight: 1.6, color: '#c2c2c2' }}>
                    {f.body}
                  </p>
                </div>
              </div>
  ...
  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginTop: 32, maxWidth: 640 }}>
    {sec.personas.map((p, i) => (
      ...
      >
        ...
        <h4 style={{ margin: '0 0 6px', fontSize: 20, fontWeight: 700, color: '#ffffff' }}>
          {p.name}
        </h4>
        <p
          style={{
        ...
        <p style={{ margin: 0, fontSize: 14, lineHeight: 1.6, color: '#f1fbec' }}>
          {p.description}
        </p>
...
{data.galleryImages && data.galleryImages.length > 0 && (
  <section className="cs-padded" style={{ paddingTop: isMobile ? 40 : 80, paddingBottom: isMobile ? 40 : 80, borderTop: '1px solid #1c1c1c' }}>
    {isMobile ? (
      ...
      {nextProject && (
        <section className="cs-padded" style={{ paddingTop: 0, paddingBottom: isMobile ? 60 : 90, borderTop: '1px solid #1c1c1c' }}>
          <Link
          ...
          >
            <div>
              <span style={{ display: 'block', fontSize: 12, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#8f8f8f', marginBottom: 8 }}>
                Next Project
              </span>
              <span style={{ fontSize: isMobile ? 22 : 40, fontWeight: 800, textTransform: 'uppercase' }}>
                {nextProject.title}
              </span>
            </div>
